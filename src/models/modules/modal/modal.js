 ...
 * @LastEditTime: 2026-01-30 12:58:38
...
const modalTemplate = getTemplate("modal");
const modalHeadTemplate = getTemplate("modalHead");
const modalMainTemplate = getTemplate("modalMain");
const modalFootTemplate = getTemplate("modalFooter");
