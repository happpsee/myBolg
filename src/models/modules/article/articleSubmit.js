...
import { http, Message } from "../../../utils/index.js";
import { routerjs } from "../../../router/index.js";
const articleSubmitTemp = getTemplate("articleSubmit");
...
class ArticleSubmit {
  ...
  async render() {
    ...
    console.log(tags, "asn为");
    const customContent = articleSubmitTemp({ tags });
