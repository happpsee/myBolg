 ...
 * @LastEditTime: 2026-01-30 19:15:23
...
import ArticleSubmit from "../article/articleSubmit.js";

const editorTemplate = getTemplate("editor");
...
class editorRender {
  ...
  render() {
    //先重新渲染main-right;
    $(".js-app-right").html(editorTemplate);
  ...
  async submitArticle() {
    ...
    if (!this.articleSubmitEl) {
      this.articleSubmitEl = new ArticleSubmit()
